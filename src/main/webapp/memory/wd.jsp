...
<div style=" height: 60px; padding: 10px 20px" align="center">
	...
	style="width: 150px; height: 60px; " 	iconCls="icon-add" plain="true" id="wdAdd" onclick="wdAdd()">文档新增</a>
	</label>
</div>
<div id="wdToolbar" style="padding: 5px; height: auto">
		<div>
...
<div id="wd" class="easyui-datagrid" ></div>  
