...
public class SqlPage {
	...
	private static final Logger logger = LoggerFactory.getLogger(SqlPage.class);
	...
	public SqlPage(Object parameterObject, String sql) {
		init(parameterObject, sql);
	}

	public SqlPage(BoundSql boundSql) {
		if (boundSql != null) {
