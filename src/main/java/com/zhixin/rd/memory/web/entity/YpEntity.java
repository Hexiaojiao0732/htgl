...
public class YpEntity implements Serializable {
	...
	public String toString() {
		return "YpEntity [id=" + id + ", mc=" + mc + ", wyid=" + wyid + ", ztId=" + ztId + ", rwId=" + rwId + ", jlId="
				+ jlId + ", sc=" + sc + ", wjlx=" + wjlx + ", pssj=" + pssj + ", psdd=" + psdd + ", jj=" + jj
				+ ", gxzId=" + gxzId + ", ztmc=" + ztmc + ", jlmc=" + jlmc + ", rwxm=" + rwxm + ", gxzxm=" + gxzxm
				+ ", userID=" + userId + ", sfGk=" + sfGk + ", syz=" + syz + ", ypdz=" + ypdz + ", bz=" + bz + "]";
	}
