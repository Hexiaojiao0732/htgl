...
public class RwGxRwEntity implements Serializable {
	
	private static final long serialVersionUID = 1L;
	private long id;// ID
	private Long ssrwId;// 所属人物ID
	private String sf;// 身份：老战士、老战士亲属、学者、非遗传承人、专题研究者、其他
	private String xb;// 性别
	private String yrwgx;// 与人物关系
	private int nl;// 年龄
	...
	public Long getSsrwId() {
		return ssrwId;
	}
	public void setSsrwId(Long ssrwId) {
		this.ssrwId = ssrwId;
	}
	public String getSf() {
		return sf;
	...
	public String getYrwgx() {
		return yrwgx;
	}
	public void setYrwgx(String yrwgx) {
		this.yrwgx = yrwgx;
	}
	public int getNl() {
		return nl;
	...
	public String toString() {
		return "RwGxRwEntity [id=" + id + ", ssrwId=" + ssrwId + ", sf=" + sf + ", xb=" + xb + ", yrwgx=" + yrwgx
				+ ", nl=" + nl + ", yz=" + yz + ", mz=" + mz + ", xm=" + xm + ", pssj=" + pssj + ", psdd=" + psdd
				+ ", jj=" + jj + ", wzjj=" + wzjj + ", nbbsh=" + nbbsh + ", szn=" + szn + ", gb=" + gb + ", qtxm="
				+ qtxm + ", jg=" + jg + ", ly=" + ly + ", zp=" + zp + ", rwzp=" + rwzp + "]";
	}
