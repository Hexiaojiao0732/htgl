...
public class HttpClientUtil {
	...
	// 人员基本信息
	public static String personInfo(String url, String json) {
	...
	//人像登录
	public static String faceLogin(String url, String json) {
		String headString = "Content-type: application/json ";
		HttpResponse response = null;
		try {
			response = post(url, headString, json);
	...
	//获取faceId
	public static String faceGetBySessionId(String url, String json, String sessionId) {
	...
	//查询全国人口人像
	public static String queryQgrkImg(String url){
		HttpResponse response = null;
		try {
			response = get(url, new HashMap<String, String>(), new HashMap<String, String>());
			return response != null ? getContentInfoFromHTTPResponse(response) : "";
		} catch (Exception e) {
			logger.error("", e);
		}
	...
	public static void main(String[] args) {
		...
		String url = "http://locathost:8080";
		//
		try {
